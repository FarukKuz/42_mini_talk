...
SRC_BONUS = server_bonus.c client_bonus.c minitalk_utils.c
...
$(NAME_SERVER): server.o minitalk_utils.o $(PRINTF_LIB)
	$(CC) $(CFLAGS) $^ -o $(NAME_SERVER)

$(NAME_CLIENT): client.o minitalk_utils.o $(PRINTF_LIB)
	$(CC) $(CFLAGS) $^ -o $(NAME_CLIENT)

bonus: $(PRINTF_LIB) $(NAME_SERVER_BONUS) $(NAME_CLIENT_BONUS)

$(NAME_SERVER_BONUS): server_bonus.o minitalk_utils.o $(PRINTF_LIB)
	$(CC) $(CFLAGS) $^ -o $(NAME_SERVER_BONUS)

$(NAME_CLIENT_BONUS): client_bonus.o minitalk_utils.o $(PRINTF_LIB)
